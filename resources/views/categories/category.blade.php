                        ...
                        @endif
                            ...
                            <form method="POST" action="{{ url('/addCategory') }}">
                                ...
                                <div class="form-group row">
                                    <label for="category" class="col-md-4 col-form-label text-md-right"> Add a Category</label>
                                    <div class="col-md-6">
                            ...
                            <ul>
                                @foreach($categories as $category)
                                    <li>{{$category->category}}</li><a href="category/delete/{{$category->id}}">delete</a>
                                @endforeach
